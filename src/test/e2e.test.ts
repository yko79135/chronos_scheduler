...
test('production bundle serves workflow shell for browser automation',()=>{const py=String.raw`
...
`;const out=execFileSync('python3',['-c',py],{encoding:'utf8'}).trim();assert.equal(out.endsWith('True'),true);});
